...
class _$Photo extends Photo {
  ...
  _$Photo._({this.id, this.width, this.height, this.likes, this.description, this.altDescription, this.urls})
      : super._() {
    if (id == null) {
  ...
  int get hashCode {
    return $jf($jc(
        $jc(
            $jc($jc($jc($jc($jc(0, id.hashCode), width.hashCode), height.hashCode), likes.hashCode),
